...
namespace WanderHub.API.Middleware;
...
internal sealed class ExceptionHandlingMiddleware : IMiddleware
{
    ...
    private static IReadOnlyCollection<WanderHub.Application.Exceptions.ValidationError> GetErrors(Exception exception)
    {
        IReadOnlyCollection<WanderHub.Application.Exceptions.ValidationError> errors = null;

        if (exception is WanderHub.Application.Exceptions.ValidationException validationException)
        {
